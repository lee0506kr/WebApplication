...
<body>
	...
	<%--get방식에서 주소값에 한글을 표시할 땐 RFC2396규약에 의해서 한글변환 형태로 전송 
	
		http표준의 기본 인커딩 ISO-8859-1
	--%>
	...
	이름 :<%=request.getParameter("name")%><br> 주소 :<%=request.getParameter("address")%><br>
	...
	%>
	<br> ========================request.getParameterNames()==========
	<!-- request에 포함된 모든 파라미터의 이름 가져오기 이름을 반환하는 함수 -->
	<br>
	<%
